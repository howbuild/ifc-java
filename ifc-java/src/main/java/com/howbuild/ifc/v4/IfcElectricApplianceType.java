 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcelectricappliancetype.htm">IfcElectricApplianceType</a>
 */
public class IfcElectricApplianceType extends IfcFlowTerminalType {
    protected IfcElectricApplianceTypeEnum predefinedType;

    protected IfcElectricApplianceType() { initCollections(); }
    /**
     * Constructs IfcElectricApplianceType with all required attributes.
     */
    ...
    /**
     * Constructs IfcElectricApplianceType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcElectricApplianceTypeEnum value) { this.predefinedType = value; }
