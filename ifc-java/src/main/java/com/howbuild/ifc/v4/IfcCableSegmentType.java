 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccablesegmenttype.htm">IfcCableSegmentType</a>
 */
public class IfcCableSegmentType extends IfcFlowSegmentType {
    protected IfcCableSegmentTypeEnum predefinedType;

    protected IfcCableSegmentType() { initCollections(); }
    /**
     * Constructs IfcCableSegmentType with all required attributes.
     */
    ...
    /**
     * Constructs IfcCableSegmentType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcCableSegmentTypeEnum value) { this.predefinedType = value; }
