 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcenergymeasure.htm">IfcEnergyMeasure</a>
 */
public class IfcEnergyMeasure extends BaseIfc implements IfcDerivedMeasureValue, SimpleType {
