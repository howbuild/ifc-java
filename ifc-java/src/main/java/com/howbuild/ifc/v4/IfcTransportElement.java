 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifctransportelement.htm">IfcTransportElement</a>
 */
public class IfcTransportElement extends IfcElement {
    protected IfcTransportElementTypeEnum predefinedType;

    protected IfcTransportElement() { initCollections(); }
    /**
     * Constructs IfcTransportElement with all required attributes.
     */
    ...
    /**
     * Constructs IfcTransportElement with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcTransportElementTypeEnum value) { this.predefinedType = value; } // optional
