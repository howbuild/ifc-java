 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcelectricgeneratortype.htm">IfcElectricGeneratorType</a>
 */
public class IfcElectricGeneratorType extends IfcEnergyConversionDeviceType {
    protected IfcElectricGeneratorTypeEnum predefinedType;

    protected IfcElectricGeneratorType() { initCollections(); }
    /**
     * Constructs IfcElectricGeneratorType with all required attributes.
     */
    ...
    /**
     * Constructs IfcElectricGeneratorType with required and optional attributes.
     */
    ...
    public IfcElectricGeneratorTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcElectricGeneratorTypeEnum value) { this.predefinedType = value; }
