 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcvalvetype.htm">IfcValveType</a>
 */
public class IfcValveType extends IfcFlowControllerType {
    protected IfcValveTypeEnum predefinedType;

    protected IfcValveType() { initCollections(); }
    /**
     * Constructs IfcValveType with all required attributes.
     */
    ...
    /**
     * Constructs IfcValveType with required and optional attributes.
     */
    ...
    public IfcValveTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcValveTypeEnum value) { this.predefinedType = value; }
