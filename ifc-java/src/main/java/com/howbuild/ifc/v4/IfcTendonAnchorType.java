 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifctendonanchortype.htm">IfcTendonAnchorType</a>
 */
public class IfcTendonAnchorType extends IfcReinforcingElementType {
    protected IfcTendonAnchorTypeEnum predefinedType;

    protected IfcTendonAnchorType() { initCollections(); }
    /**
     * Constructs IfcTendonAnchorType with all required attributes.
     */
    ...
    /**
     * Constructs IfcTendonAnchorType with required and optional attributes.
     */
    ...
    public IfcTendonAnchorTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcTendonAnchorTypeEnum value) { this.predefinedType = value; }
