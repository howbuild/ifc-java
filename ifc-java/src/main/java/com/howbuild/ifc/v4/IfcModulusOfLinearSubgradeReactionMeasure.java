 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcmodulusoflinearsubgradereactionmeasure.htm">IfcModulusOfLinearSubgradeReactionMeasure</a>
 */
public class IfcModulusOfLinearSubgradeReactionMeasure extends BaseIfc implements IfcModulusOfTranslationalSubgradeReactionSelect, IfcDerivedMeasureValue, SimpleType {
