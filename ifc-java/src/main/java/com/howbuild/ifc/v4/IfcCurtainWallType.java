 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccurtainwalltype.htm">IfcCurtainWallType</a>
 */
public class IfcCurtainWallType extends IfcBuildingElementType {
    protected IfcCurtainWallTypeEnum predefinedType;

    protected IfcCurtainWallType() { initCollections(); }
    /**
     * Constructs IfcCurtainWallType with all required attributes.
     */
    ...
    /**
     * Constructs IfcCurtainWallType with required and optional attributes.
     */
    ...
    public IfcCurtainWallTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcCurtainWallTypeEnum value) { this.predefinedType = value; }
