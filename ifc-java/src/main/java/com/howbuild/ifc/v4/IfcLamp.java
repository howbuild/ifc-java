 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifclamp.htm">IfcLamp</a>
 */
public class IfcLamp extends IfcFlowTerminal {
    protected IfcLampTypeEnum predefinedType;

    protected IfcLamp() { initCollections(); }
    /**
     * Constructs IfcLamp with all required attributes.
     */
    ...
    /**
     * Constructs IfcLamp with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcLampTypeEnum value) { this.predefinedType = value; } // optional
