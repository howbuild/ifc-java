 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcdampertype.htm">IfcDamperType</a>
 */
public class IfcDamperType extends IfcFlowControllerType {
    protected IfcDamperTypeEnum predefinedType;

    protected IfcDamperType() { initCollections(); }
    /**
     * Constructs IfcDamperType with all required attributes.
     */
    ...
    /**
     * Constructs IfcDamperType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcDamperTypeEnum value) { this.predefinedType = value; }
