 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifctransformertype.htm">IfcTransformerType</a>
 */
public class IfcTransformerType extends IfcEnergyConversionDeviceType {
    protected IfcTransformerTypeEnum predefinedType;

    protected IfcTransformerType() { initCollections(); }
    /**
     * Constructs IfcTransformerType with all required attributes.
     */
    ...
    /**
     * Constructs IfcTransformerType with required and optional attributes.
     */
    ...
    public IfcTransformerTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcTransformerTypeEnum value) { this.predefinedType = value; }
