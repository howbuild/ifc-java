 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcrampflight.htm">IfcRampFlight</a>
 */
public class IfcRampFlight extends IfcBuildingElement {
    protected IfcRampFlightTypeEnum predefinedType;

    protected IfcRampFlight() { initCollections(); }
    /**
     * Constructs IfcRampFlight with all required attributes.
     */
    ...
    /**
     * Constructs IfcRampFlight with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcRampFlightTypeEnum value) { this.predefinedType = value; } // optional
