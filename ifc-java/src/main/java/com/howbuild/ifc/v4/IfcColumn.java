 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccolumn.htm">IfcColumn</a>
 */
public class IfcColumn extends IfcBuildingElement {
    protected IfcColumnTypeEnum predefinedType;

    protected IfcColumn() { initCollections(); }
    /**
     * Constructs IfcColumn with all required attributes.
     */
    ...
    /**
     * Constructs IfcColumn with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcColumnTypeEnum value) { this.predefinedType = value; } // optional
