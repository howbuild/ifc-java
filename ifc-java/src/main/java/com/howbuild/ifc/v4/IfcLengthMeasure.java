 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifclengthmeasure.htm">IfcLengthMeasure</a>
 */
public class IfcLengthMeasure extends BaseIfc implements IfcMeasureValue, IfcSizeSelect, IfcBendingParameterSelect, SimpleType {
