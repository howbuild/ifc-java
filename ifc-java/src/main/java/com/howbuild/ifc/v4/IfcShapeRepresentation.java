 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcshaperepresentation.htm">IfcShapeRepresentation</a>
 */
public class IfcShapeRepresentation extends IfcShapeModel {

    protected IfcShapeRepresentation() { initCollections(); }
    /**
     * Constructs IfcShapeRepresentation with all required attributes.
     */
    public IfcShapeRepresentation(IfcRepresentationContext contextOfItems,Collection<IfcRepresentationItem> items) {

        super(contextOfItems,items);
    }
    /**
     * Constructs IfcShapeRepresentation with required and optional attributes.
     */
    public IfcShapeRepresentation(IfcRepresentationContext contextOfItems,IfcLabel representationIdentifier,IfcLabel representationType,Collection<IfcRepresentationItem> items) {
