 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcsensor.htm">IfcSensor</a>
 */
public class IfcSensor extends IfcDistributionControlElement {
    protected IfcSensorTypeEnum predefinedType;

    protected IfcSensor() { initCollections(); }
    /**
     * Constructs IfcSensor with all required attributes.
     */
    ...
    /**
     * Constructs IfcSensor with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcSensorTypeEnum value) { this.predefinedType = value; } // optional
