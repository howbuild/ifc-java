 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcworkplan.htm">IfcWorkPlan</a>
 */
public class IfcWorkPlan extends IfcWorkControl {
    protected IfcWorkPlanTypeEnum predefinedType;

    protected IfcWorkPlan() { initCollections(); }
    /**
     * Constructs IfcWorkPlan with all required attributes.
     */
    ...
    /**
     * Constructs IfcWorkPlan with required and optional attributes.
     */
    ...
    public IfcWorkPlanTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcWorkPlanTypeEnum value) { this.predefinedType = value; } // optional
