 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcflowstoragedevice.htm">IfcFlowStorageDevice</a>
 */
public class IfcFlowStorageDevice extends IfcDistributionFlowElement {

    protected IfcFlowStorageDevice() { initCollections(); }
    /**
     * Constructs IfcFlowStorageDevice with all required attributes.
     */
    ...
    /**
     * Constructs IfcFlowStorageDevice with required and optional attributes.
     */
