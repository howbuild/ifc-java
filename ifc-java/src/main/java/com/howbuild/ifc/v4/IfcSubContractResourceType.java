 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcsubcontractresourcetype.htm">IfcSubContractResourceType</a>
 */
public class IfcSubContractResourceType extends IfcConstructionResourceType {
    ...
    protected IfcSubContractResourceType() { initCollections(); }
    /**
     * Constructs IfcSubContractResourceType with all required attributes.
     */
    ...
    /**
     * Constructs IfcSubContractResourceType with required and optional attributes.
     */
    public IfcSubContractResourceType(IfcGloballyUniqueId globalId,IfcOwnerHistory ownerHistory,IfcLabel name,IfcText description,IfcIdentifier applicableOccurrence,Collection<IfcPropertySetDefinition> hasPropertySets,IfcIdentifier identification,IfcText longDescription,IfcLabel resourceType,Collection<IfcAppliedValue> baseCosts,IfcPhysicalQuantity baseQuantity,IfcSubContractResourceTypeEnum predefinedType) {
    ...
    public void setPredefinedType(IfcSubContractResourceTypeEnum value) { this.predefinedType = value; }
