 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcflowtreatmentdevice.htm">IfcFlowTreatmentDevice</a>
 */
public class IfcFlowTreatmentDevice extends IfcDistributionFlowElement {

    protected IfcFlowTreatmentDevice() { initCollections(); }
    /**
     * Constructs IfcFlowTreatmentDevice with all required attributes.
     */
    ...
    /**
     * Constructs IfcFlowTreatmentDevice with required and optional attributes.
     */
