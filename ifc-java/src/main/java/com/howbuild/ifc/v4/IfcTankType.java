 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifctanktype.htm">IfcTankType</a>
 */
public class IfcTankType extends IfcFlowStorageDeviceType {
    protected IfcTankTypeEnum predefinedType;

    protected IfcTankType() { initCollections(); }
    /**
     * Constructs IfcTankType with all required attributes.
     */
    ...
    /**
     * Constructs IfcTankType with required and optional attributes.
     */
    ...
    public IfcTankTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcTankTypeEnum value) { this.predefinedType = value; }
