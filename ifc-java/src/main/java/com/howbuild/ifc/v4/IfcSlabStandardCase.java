 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcslabstandardcase.htm">IfcSlabStandardCase</a>
 */
public class IfcSlabStandardCase extends IfcSlab {

    protected IfcSlabStandardCase() { initCollections(); }
    /**
     * Constructs IfcSlabStandardCase with all required attributes.
     */
    ...
    /**
     * Constructs IfcSlabStandardCase with required and optional attributes.
     */
