 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcdescriptivemeasure.htm">IfcDescriptiveMeasure</a>
 */
public class IfcDescriptiveMeasure extends BaseIfc implements IfcMeasureValue, IfcSizeSelect, SimpleType {
