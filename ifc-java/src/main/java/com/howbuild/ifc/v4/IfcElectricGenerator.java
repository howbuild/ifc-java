 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcelectricgenerator.htm">IfcElectricGenerator</a>
 */
public class IfcElectricGenerator extends IfcEnergyConversionDevice {
    protected IfcElectricGeneratorTypeEnum predefinedType;

    protected IfcElectricGenerator() { initCollections(); }
    /**
     * Constructs IfcElectricGenerator with all required attributes.
     */
    ...
    /**
     * Constructs IfcElectricGenerator with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcElectricGeneratorTypeEnum value) { this.predefinedType = value; } // optional
