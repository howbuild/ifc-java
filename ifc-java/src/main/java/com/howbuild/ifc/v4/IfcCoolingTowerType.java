 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccoolingtowertype.htm">IfcCoolingTowerType</a>
 */
public class IfcCoolingTowerType extends IfcEnergyConversionDeviceType {
    protected IfcCoolingTowerTypeEnum predefinedType;

    protected IfcCoolingTowerType() { initCollections(); }
    /**
     * Constructs IfcCoolingTowerType with all required attributes.
     */
    ...
    /**
     * Constructs IfcCoolingTowerType with required and optional attributes.
     */
    ...
    public IfcCoolingTowerTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcCoolingTowerTypeEnum value) { this.predefinedType = value; }
