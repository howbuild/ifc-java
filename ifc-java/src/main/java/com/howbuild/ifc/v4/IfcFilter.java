 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcfilter.htm">IfcFilter</a>
 */
public class IfcFilter extends IfcFlowTreatmentDevice {
    protected IfcFilterTypeEnum predefinedType;

    protected IfcFilter() { initCollections(); }
    /**
     * Constructs IfcFilter with all required attributes.
     */
    ...
    /**
     * Constructs IfcFilter with required and optional attributes.
     */
    ...
    public IfcFilterTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcFilterTypeEnum value) { this.predefinedType = value; } // optional
