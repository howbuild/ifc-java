 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcrailingtype.htm">IfcRailingType</a>
 */
public class IfcRailingType extends IfcBuildingElementType {
    protected IfcRailingTypeEnum predefinedType;

    protected IfcRailingType() { initCollections(); }
    /**
     * Constructs IfcRailingType with all required attributes.
     */
    ...
    /**
     * Constructs IfcRailingType with required and optional attributes.
     */
    ...
    public IfcRailingTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcRailingTypeEnum value) { this.predefinedType = value; }
