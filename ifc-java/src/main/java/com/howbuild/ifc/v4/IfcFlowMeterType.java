 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcflowmetertype.htm">IfcFlowMeterType</a>
 */
public class IfcFlowMeterType extends IfcFlowControllerType {
    protected IfcFlowMeterTypeEnum predefinedType;

    protected IfcFlowMeterType() { initCollections(); }
    /**
     * Constructs IfcFlowMeterType with all required attributes.
     */
    ...
    /**
     * Constructs IfcFlowMeterType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcFlowMeterTypeEnum value) { this.predefinedType = value; }
