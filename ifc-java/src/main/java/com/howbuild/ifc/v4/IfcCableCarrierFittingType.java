 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccablecarrierfittingtype.htm">IfcCableCarrierFittingType</a>
 */
public class IfcCableCarrierFittingType extends IfcFlowFittingType {
    ...
    protected IfcCableCarrierFittingType() { initCollections(); }
    /**
     * Constructs IfcCableCarrierFittingType with all required attributes.
     */
    ...
    /**
     * Constructs IfcCableCarrierFittingType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcCableCarrierFittingTypeEnum value) { this.predefinedType = value; }
