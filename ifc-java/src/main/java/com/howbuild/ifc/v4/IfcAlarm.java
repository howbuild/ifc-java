 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcalarm.htm">IfcAlarm</a>
 */
public class IfcAlarm extends IfcDistributionControlElement {
    protected IfcAlarmTypeEnum predefinedType;

    protected IfcAlarm() { initCollections(); }
    /**
     * Constructs IfcAlarm with all required attributes.
     */
    ...
    /**
     * Constructs IfcAlarm with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcAlarmTypeEnum value) { this.predefinedType = value; } // optional
