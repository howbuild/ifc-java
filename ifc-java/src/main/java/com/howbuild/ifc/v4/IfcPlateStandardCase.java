 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcplatestandardcase.htm">IfcPlateStandardCase</a>
 */
public class IfcPlateStandardCase extends IfcPlate {

    protected IfcPlateStandardCase() { initCollections(); }
    /**
     * Constructs IfcPlateStandardCase with all required attributes.
     */
    ...
    /**
     * Constructs IfcPlateStandardCase with required and optional attributes.
     */
