 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcgeographicelement.htm">IfcGeographicElement</a>
 */
public class IfcGeographicElement extends IfcElement {
    protected IfcGeographicElementTypeEnum predefinedType;

    protected IfcGeographicElement() { initCollections(); }
    /**
     * Constructs IfcGeographicElement with all required attributes.
     */
    ...
    /**
     * Constructs IfcGeographicElement with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcGeographicElementTypeEnum value) { this.predefinedType = value; } // optional
