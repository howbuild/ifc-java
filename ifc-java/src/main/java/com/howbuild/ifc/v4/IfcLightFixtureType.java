 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifclightfixturetype.htm">IfcLightFixtureType</a>
 */
public class IfcLightFixtureType extends IfcFlowTerminalType {
    protected IfcLightFixtureTypeEnum predefinedType;

    protected IfcLightFixtureType() { initCollections(); }
    /**
     * Constructs IfcLightFixtureType with all required attributes.
     */
    ...
    /**
     * Constructs IfcLightFixtureType with required and optional attributes.
     */
    ...
    public IfcLightFixtureTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcLightFixtureTypeEnum value) { this.predefinedType = value; }
