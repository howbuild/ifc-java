 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcsanitaryterminaltype.htm">IfcSanitaryTerminalType</a>
 */
public class IfcSanitaryTerminalType extends IfcFlowTerminalType {
    protected IfcSanitaryTerminalTypeEnum predefinedType;

    protected IfcSanitaryTerminalType() { initCollections(); }
    /**
     * Constructs IfcSanitaryTerminalType with all required attributes.
     */
    ...
    /**
     * Constructs IfcSanitaryTerminalType with required and optional attributes.
     */
    ...
    public IfcSanitaryTerminalTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcSanitaryTerminalTypeEnum value) { this.predefinedType = value; }
