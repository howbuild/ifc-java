 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifclabel.htm">IfcLabel</a>
 */
public class IfcLabel extends BaseIfc implements IfcSimpleValue, SimpleType {
