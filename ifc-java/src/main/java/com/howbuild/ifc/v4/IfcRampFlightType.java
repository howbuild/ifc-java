 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcrampflighttype.htm">IfcRampFlightType</a>
 */
public class IfcRampFlightType extends IfcBuildingElementType {
    protected IfcRampFlightTypeEnum predefinedType;

    protected IfcRampFlightType() { initCollections(); }
    /**
     * Constructs IfcRampFlightType with all required attributes.
     */
    ...
    /**
     * Constructs IfcRampFlightType with required and optional attributes.
     */
    ...
    public IfcRampFlightTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcRampFlightTypeEnum value) { this.predefinedType = value; }
