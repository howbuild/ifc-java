 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcmember.htm">IfcMember</a>
 */
public class IfcMember extends IfcBuildingElement {
    protected IfcMemberTypeEnum predefinedType;

    protected IfcMember() { initCollections(); }
    /**
     * Constructs IfcMember with all required attributes.
     */
    ...
    /**
     * Constructs IfcMember with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcMemberTypeEnum value) { this.predefinedType = value; } // optional
