 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcthermalexpansioncoefficientmeasure.htm">IfcThermalExpansionCoefficientMeasure</a>
 */
public class IfcThermalExpansionCoefficientMeasure extends BaseIfc implements IfcDerivedMeasureValue, SimpleType {
