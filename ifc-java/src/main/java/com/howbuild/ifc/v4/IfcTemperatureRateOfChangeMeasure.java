 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifctemperaturerateofchangemeasure.htm">IfcTemperatureRateOfChangeMeasure</a>
 */
public class IfcTemperatureRateOfChangeMeasure extends BaseIfc implements IfcDerivedMeasureValue, SimpleType {
