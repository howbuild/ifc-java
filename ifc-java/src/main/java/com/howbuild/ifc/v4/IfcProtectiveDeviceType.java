 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcprotectivedevicetype.htm">IfcProtectiveDeviceType</a>
 */
public class IfcProtectiveDeviceType extends IfcFlowControllerType {
    protected IfcProtectiveDeviceTypeEnum predefinedType;

    protected IfcProtectiveDeviceType() { initCollections(); }
    /**
     * Constructs IfcProtectiveDeviceType with all required attributes.
     */
    ...
    /**
     * Constructs IfcProtectiveDeviceType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcProtectiveDeviceTypeEnum value) { this.predefinedType = value; }
