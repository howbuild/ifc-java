 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcairterminal.htm">IfcAirTerminal</a>
 */
public class IfcAirTerminal extends IfcFlowTerminal {
    protected IfcAirTerminalTypeEnum predefinedType;

    protected IfcAirTerminal() { initCollections(); }
    /**
     * Constructs IfcAirTerminal with all required attributes.
     */
    ...
    /**
     * Constructs IfcAirTerminal with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcAirTerminalTypeEnum value) { this.predefinedType = value; } // optional
