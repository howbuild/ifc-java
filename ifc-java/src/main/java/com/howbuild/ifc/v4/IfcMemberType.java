 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcmembertype.htm">IfcMemberType</a>
 */
public class IfcMemberType extends IfcBuildingElementType {
    protected IfcMemberTypeEnum predefinedType;

    protected IfcMemberType() { initCollections(); }
    /**
     * Constructs IfcMemberType with all required attributes.
     */
    ...
    /**
     * Constructs IfcMemberType with required and optional attributes.
     */
    ...
    public IfcMemberTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcMemberTypeEnum value) { this.predefinedType = value; }
