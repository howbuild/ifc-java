 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccablesegment.htm">IfcCableSegment</a>
 */
public class IfcCableSegment extends IfcFlowSegment {
    protected IfcCableSegmentTypeEnum predefinedType;

    protected IfcCableSegment() { initCollections(); }
    /**
     * Constructs IfcCableSegment with all required attributes.
     */
    ...
    /**
     * Constructs IfcCableSegment with required and optional attributes.
     */
    ...
    public IfcCableSegmentTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcCableSegmentTypeEnum value) { this.predefinedType = value; } // optional
