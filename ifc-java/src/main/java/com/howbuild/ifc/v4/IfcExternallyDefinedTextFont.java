 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcexternallydefinedtextfont.htm">IfcExternallyDefinedTextFont</a>
 */
public class IfcExternallyDefinedTextFont extends IfcExternalReference implements IfcTextFontSelect {


    /**
     * Constructs IfcExternallyDefinedTextFont with all required attributes.
     */
    ...
    /**
     * Constructs IfcExternallyDefinedTextFont with required and optional attributes.
     */
