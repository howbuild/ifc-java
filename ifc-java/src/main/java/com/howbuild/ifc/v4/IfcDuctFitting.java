 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcductfitting.htm">IfcDuctFitting</a>
 */
public class IfcDuctFitting extends IfcFlowFitting {
    protected IfcDuctFittingTypeEnum predefinedType;

    protected IfcDuctFitting() { initCollections(); }
    /**
     * Constructs IfcDuctFitting with all required attributes.
     */
    ...
    /**
     * Constructs IfcDuctFitting with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcDuctFittingTypeEnum value) { this.predefinedType = value; } // optional
