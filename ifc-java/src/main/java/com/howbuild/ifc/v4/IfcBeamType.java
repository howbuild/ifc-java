 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcbeamtype.htm">IfcBeamType</a>
 */
public class IfcBeamType extends IfcBuildingElementType {
    protected IfcBeamTypeEnum predefinedType;

    protected IfcBeamType() { initCollections(); }
    /**
     * Constructs IfcBeamType with all required attributes.
     */
    ...
    /**
     * Constructs IfcBeamType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcBeamTypeEnum value) { this.predefinedType = value; }
