 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcmassmeasure.htm">IfcMassMeasure</a>
 */
public class IfcMassMeasure extends BaseIfc implements IfcMeasureValue, SimpleType {
