 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccontrollertype.htm">IfcControllerType</a>
 */
public class IfcControllerType extends IfcDistributionControlElementType {
    protected IfcControllerTypeEnum predefinedType;

    protected IfcControllerType() { initCollections(); }
    /**
     * Constructs IfcControllerType with all required attributes.
     */
    ...
    /**
     * Constructs IfcControllerType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcControllerTypeEnum value) { this.predefinedType = value; }
