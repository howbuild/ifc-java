 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcsolardevicetype.htm">IfcSolarDeviceType</a>
 */
public class IfcSolarDeviceType extends IfcEnergyConversionDeviceType {
    protected IfcSolarDeviceTypeEnum predefinedType;

    protected IfcSolarDeviceType() { initCollections(); }
    /**
     * Constructs IfcSolarDeviceType with all required attributes.
     */
    ...
    /**
     * Constructs IfcSolarDeviceType with required and optional attributes.
     */
    ...
    public IfcSolarDeviceTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcSolarDeviceTypeEnum value) { this.predefinedType = value; }
