 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcarcindex.htm">IfcArcIndex</a>
 */
public class IfcArcIndex extends BaseIfc implements IfcSegmentIndexSelect, SimpleType {
    ...
    public IfcArcIndex(Collection<IfcPositiveInteger> value){ this.value = value; }
    public IfcArcIndex() { }
