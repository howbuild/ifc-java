 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcelectricappliance.htm">IfcElectricAppliance</a>
 */
public class IfcElectricAppliance extends IfcFlowTerminal {
    protected IfcElectricApplianceTypeEnum predefinedType;

    protected IfcElectricAppliance() { initCollections(); }
    /**
     * Constructs IfcElectricAppliance with all required attributes.
     */
    ...
    /**
     * Constructs IfcElectricAppliance with required and optional attributes.
     */
    ...
    public IfcElectricApplianceTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcElectricApplianceTypeEnum value) { this.predefinedType = value; } // optional
