 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcfantype.htm">IfcFanType</a>
 */
public class IfcFanType extends IfcFlowMovingDeviceType {
    protected IfcFanTypeEnum predefinedType;

    protected IfcFanType() { initCollections(); }
    /**
     * Constructs IfcFanType with all required attributes.
     */
    ...
    public void setPredefinedType(IfcFanTypeEnum value) { this.predefinedType = value; }
