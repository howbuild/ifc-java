 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcdistributionchamberelementtype.htm">IfcDistributionChamberElementType</a>
 */
public class IfcDistributionChamberElementType extends IfcDistributionFlowElementType {
    ...
    protected IfcDistributionChamberElementType() { initCollections(); }
    /**
     * Constructs IfcDistributionChamberElementType with all required attributes.
     */
    ...
    /**
     * Constructs IfcDistributionChamberElementType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcDistributionChamberElementTypeEnum value) { this.predefinedType = value; }
