 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifchumidifiertype.htm">IfcHumidifierType</a>
 */
public class IfcHumidifierType extends IfcEnergyConversionDeviceType {
    protected IfcHumidifierTypeEnum predefinedType;

    protected IfcHumidifierType() { initCollections(); }
    /**
     * Constructs IfcHumidifierType with all required attributes.
     */
    ...
    /**
     * Constructs IfcHumidifierType with required and optional attributes.
     */
    ...
    public IfcHumidifierTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcHumidifierTypeEnum value) { this.predefinedType = value; }
