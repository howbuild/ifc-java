 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcpowermeasure.htm">IfcPowerMeasure</a>
 */
public class IfcPowerMeasure extends BaseIfc implements IfcDerivedMeasureValue, SimpleType {
