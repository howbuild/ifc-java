 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcrailing.htm">IfcRailing</a>
 */
public class IfcRailing extends IfcBuildingElement {
    protected IfcRailingTypeEnum predefinedType;

    protected IfcRailing() { initCollections(); }
    /**
     * Constructs IfcRailing with all required attributes.
     */
    ...
    /**
     * Constructs IfcRailing with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcRailingTypeEnum value) { this.predefinedType = value; } // optional
