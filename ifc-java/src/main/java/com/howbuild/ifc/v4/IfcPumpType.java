 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcpumptype.htm">IfcPumpType</a>
 */
public class IfcPumpType extends IfcFlowMovingDeviceType {
    protected IfcPumpTypeEnum predefinedType;

    protected IfcPumpType() { initCollections(); }
    /**
     * Constructs IfcPumpType with all required attributes.
     */
    ...
    /**
     * Constructs IfcPumpType with required and optional attributes.
     */
    ...
    public IfcPumpTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcPumpTypeEnum value) { this.predefinedType = value; }
