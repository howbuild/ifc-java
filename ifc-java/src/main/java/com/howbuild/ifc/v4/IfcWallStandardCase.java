 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcwallstandardcase.htm">IfcWallStandardCase</a>
 */
public class IfcWallStandardCase extends IfcWall {

    protected IfcWallStandardCase() { initCollections(); }
    /**
     * Constructs IfcWallStandardCase with all required attributes.
     */
    ...
    /**
     * Constructs IfcWallStandardCase with required and optional attributes.
     */
