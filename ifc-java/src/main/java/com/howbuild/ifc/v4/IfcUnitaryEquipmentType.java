 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcunitaryequipmenttype.htm">IfcUnitaryEquipmentType</a>
 */
public class IfcUnitaryEquipmentType extends IfcEnergyConversionDeviceType {
    ...
    protected IfcUnitaryEquipmentType() { initCollections(); }
    /**
     * Constructs IfcUnitaryEquipmentType with all required attributes.
     */
    ...
    /**
     * Constructs IfcUnitaryEquipmentType with required and optional attributes.
     */
    ...
    public IfcUnitaryEquipmentTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcUnitaryEquipmentTypeEnum value) { this.predefinedType = value; }
