 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcchiller.htm">IfcChiller</a>
 */
public class IfcChiller extends IfcEnergyConversionDevice {
    protected IfcChillerTypeEnum predefinedType;

    protected IfcChiller() { initCollections(); }
    /**
     * Constructs IfcChiller with all required attributes.
     */
    ...
    /**
     * Constructs IfcChiller with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcChillerTypeEnum value) { this.predefinedType = value; } // optional
