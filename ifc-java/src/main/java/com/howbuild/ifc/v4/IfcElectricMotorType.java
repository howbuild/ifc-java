 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcelectricmotortype.htm">IfcElectricMotorType</a>
 */
public class IfcElectricMotorType extends IfcEnergyConversionDeviceType {
    protected IfcElectricMotorTypeEnum predefinedType;

    protected IfcElectricMotorType() { initCollections(); }
    /**
     * Constructs IfcElectricMotorType with all required attributes.
     */
    ...
    /**
     * Constructs IfcElectricMotorType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcElectricMotorTypeEnum value) { this.predefinedType = value; }
