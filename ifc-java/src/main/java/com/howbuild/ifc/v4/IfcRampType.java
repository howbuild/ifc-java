 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcramptype.htm">IfcRampType</a>
 */
public class IfcRampType extends IfcBuildingElementType {
    protected IfcRampTypeEnum predefinedType;

    protected IfcRampType() { initCollections(); }
    /**
     * Constructs IfcRampType with all required attributes.
     */
    ...
    /**
     * Constructs IfcRampType with required and optional attributes.
     */
    ...
    public IfcRampTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcRampTypeEnum value) { this.predefinedType = value; }
