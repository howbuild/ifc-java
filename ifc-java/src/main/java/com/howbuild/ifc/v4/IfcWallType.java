 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcwalltype.htm">IfcWallType</a>
 */
public class IfcWallType extends IfcBuildingElementType {
    protected IfcWallTypeEnum predefinedType;

    protected IfcWallType() { initCollections(); }
    /**
     * Constructs IfcWallType with all required attributes.
     */
    ...
    /**
     * Constructs IfcWallType with required and optional attributes.
     */
    ...
    public IfcWallTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcWallTypeEnum value) { this.predefinedType = value; }
