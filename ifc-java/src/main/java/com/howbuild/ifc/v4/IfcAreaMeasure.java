 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcareameasure.htm">IfcAreaMeasure</a>
 */
public class IfcAreaMeasure extends BaseIfc implements IfcMeasureValue, SimpleType {
