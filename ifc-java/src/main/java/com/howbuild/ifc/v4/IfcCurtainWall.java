 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccurtainwall.htm">IfcCurtainWall</a>
 */
public class IfcCurtainWall extends IfcBuildingElement {
    protected IfcCurtainWallTypeEnum predefinedType;

    protected IfcCurtainWall() { initCollections(); }
    /**
     * Constructs IfcCurtainWall with all required attributes.
     */
    ...
    /**
     * Constructs IfcCurtainWall with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcCurtainWallTypeEnum value) { this.predefinedType = value; } // optional
