 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcforcemeasure.htm">IfcForceMeasure</a>
 */
public class IfcForceMeasure extends BaseIfc implements IfcDerivedMeasureValue, SimpleType {
