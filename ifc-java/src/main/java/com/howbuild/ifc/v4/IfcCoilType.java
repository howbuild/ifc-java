 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccoiltype.htm">IfcCoilType</a>
 */
public class IfcCoilType extends IfcEnergyConversionDeviceType {
    protected IfcCoilTypeEnum predefinedType;

    protected IfcCoilType() { initCollections(); }
    /**
     * Constructs IfcCoilType with all required attributes.
     */
    ...
    /**
     * Constructs IfcCoilType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcCoilTypeEnum value) { this.predefinedType = value; }
