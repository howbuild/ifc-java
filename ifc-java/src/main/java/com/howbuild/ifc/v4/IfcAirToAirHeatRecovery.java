 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcairtoairheatrecovery.htm">IfcAirToAirHeatRecovery</a>
 */
public class IfcAirToAirHeatRecovery extends IfcEnergyConversionDevice {
    ...
    protected IfcAirToAirHeatRecovery() { initCollections(); }
    /**
     * Constructs IfcAirToAirHeatRecovery with all required attributes.
     */
    ...
    /**
     * Constructs IfcAirToAirHeatRecovery with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcAirToAirHeatRecoveryTypeEnum value) { this.predefinedType = value; } // optional
