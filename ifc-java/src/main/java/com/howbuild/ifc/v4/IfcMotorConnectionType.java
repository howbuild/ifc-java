 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcmotorconnectiontype.htm">IfcMotorConnectionType</a>
 */
public class IfcMotorConnectionType extends IfcEnergyConversionDeviceType {
    ...
    protected IfcMotorConnectionType() { initCollections(); }
    /**
     * Constructs IfcMotorConnectionType with all required attributes.
     */
    ...
    /**
     * Constructs IfcMotorConnectionType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcMotorConnectionTypeEnum value) { this.predefinedType = value; }
