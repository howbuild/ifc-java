 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcslabtype.htm">IfcSlabType</a>
 */
public class IfcSlabType extends IfcBuildingElementType {
    protected IfcSlabTypeEnum predefinedType;

    protected IfcSlabType() { initCollections(); }
    /**
     * Constructs IfcSlabType with all required attributes.
     */
    ...
    /**
     * Constructs IfcSlabType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcSlabTypeEnum value) { this.predefinedType = value; }
