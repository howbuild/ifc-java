 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcbeamstandardcase.htm">IfcBeamStandardCase</a>
 */
public class IfcBeamStandardCase extends IfcBeam {

    protected IfcBeamStandardCase() { initCollections(); }
    /**
     * Constructs IfcBeamStandardCase with all required attributes.
     */
    public IfcBeamStandardCase(IfcGloballyUniqueId globalId) {

        super(globalId);
    }
    /**
     * Constructs IfcBeamStandardCase with required and optional attributes.
     */
