 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcrotationalstiffnessmeasure.htm">IfcRotationalStiffnessMeasure</a>
 */
public class IfcRotationalStiffnessMeasure extends BaseIfc implements IfcRotationalStiffnessSelect, IfcDerivedMeasureValue, SimpleType {
