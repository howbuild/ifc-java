 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcvibrationisolatortype.htm">IfcVibrationIsolatorType</a>
 */
public class IfcVibrationIsolatorType extends IfcElementComponentType {
    ...
    protected IfcVibrationIsolatorType() { initCollections(); }
    /**
     * Constructs IfcVibrationIsolatorType with all required attributes.
     */
    ...
    /**
     * Constructs IfcVibrationIsolatorType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcVibrationIsolatorTypeEnum value) { this.predefinedType = value; }
