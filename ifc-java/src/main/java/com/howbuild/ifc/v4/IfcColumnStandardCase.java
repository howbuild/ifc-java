 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccolumnstandardcase.htm">IfcColumnStandardCase</a>
 */
public class IfcColumnStandardCase extends IfcColumn {

    protected IfcColumnStandardCase() { initCollections(); }
    /**
     * Constructs IfcColumnStandardCase with all required attributes.
     */
    public IfcColumnStandardCase(IfcGloballyUniqueId globalId) {

        super(globalId);
    }
    /**
     * Constructs IfcColumnStandardCase with required and optional attributes.
     */
