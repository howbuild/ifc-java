 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifctorquemeasure.htm">IfcTorqueMeasure</a>
 */
public class IfcTorqueMeasure extends BaseIfc implements IfcDerivedMeasureValue, SimpleType {
