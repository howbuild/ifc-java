 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcswitchingdevicetype.htm">IfcSwitchingDeviceType</a>
 */
public class IfcSwitchingDeviceType extends IfcFlowControllerType {
    protected IfcSwitchingDeviceTypeEnum predefinedType;

    protected IfcSwitchingDeviceType() { initCollections(); }
    /**
     * Constructs IfcSwitchingDeviceType with all required attributes.
     */
    ...
    /**
     * Constructs IfcSwitchingDeviceType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcSwitchingDeviceTypeEnum value) { this.predefinedType = value; }
