 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcheatexchangertype.htm">IfcHeatExchangerType</a>
 */
public class IfcHeatExchangerType extends IfcEnergyConversionDeviceType {
    protected IfcHeatExchangerTypeEnum predefinedType;

    protected IfcHeatExchangerType() { initCollections(); }
    /**
     * Constructs IfcHeatExchangerType with all required attributes.
     */
    ...
    /**
     * Constructs IfcHeatExchangerType with required and optional attributes.
     */
    ...
    public IfcHeatExchangerTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcHeatExchangerTypeEnum value) { this.predefinedType = value; }
