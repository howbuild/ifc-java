 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcbuildingelementpart.htm">IfcBuildingElementPart</a>
 */
public class IfcBuildingElementPart extends IfcElementComponent {
    protected IfcBuildingElementPartTypeEnum predefinedType;

    protected IfcBuildingElementPart() { initCollections(); }
    /**
     * Constructs IfcBuildingElementPart with all required attributes.
     */
    ...
    /**
     * Constructs IfcBuildingElementPart with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcBuildingElementPartTypeEnum value) { this.predefinedType = value; } // optional
