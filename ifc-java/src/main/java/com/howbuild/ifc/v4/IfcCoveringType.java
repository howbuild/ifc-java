 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccoveringtype.htm">IfcCoveringType</a>
 */
public class IfcCoveringType extends IfcBuildingElementType {
    protected IfcCoveringTypeEnum predefinedType;

    protected IfcCoveringType() { initCollections(); }
    /**
     * Constructs IfcCoveringType with all required attributes.
     */
    ...
    /**
     * Constructs IfcCoveringType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcCoveringTypeEnum value) { this.predefinedType = value; }
