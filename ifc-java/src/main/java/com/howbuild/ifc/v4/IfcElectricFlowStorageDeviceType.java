 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcelectricflowstoragedevicetype.htm">IfcElectricFlowStorageDeviceType</a>
 */
public class IfcElectricFlowStorageDeviceType extends IfcFlowStorageDeviceType {
    ...
    protected IfcElectricFlowStorageDeviceType() { initCollections(); }
    /**
     * Constructs IfcElectricFlowStorageDeviceType with all required attributes.
     */
    ...
    /**
     * Constructs IfcElectricFlowStorageDeviceType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcElectricFlowStorageDeviceTypeEnum value) { this.predefinedType = value; }
