 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcelementassemblytype.htm">IfcElementAssemblyType</a>
 */
public class IfcElementAssemblyType extends IfcElementType {
    protected IfcElementAssemblyTypeEnum predefinedType;

    protected IfcElementAssemblyType() { initCollections(); }
    /**
     * Constructs IfcElementAssemblyType with all required attributes.
     */
    ...
    /**
     * Constructs IfcElementAssemblyType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcElementAssemblyTypeEnum value) { this.predefinedType = value; }
