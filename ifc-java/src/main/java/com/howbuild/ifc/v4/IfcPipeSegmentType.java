 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcpipesegmenttype.htm">IfcPipeSegmentType</a>
 */
public class IfcPipeSegmentType extends IfcFlowSegmentType {
    protected IfcPipeSegmentTypeEnum predefinedType;

    protected IfcPipeSegmentType() { initCollections(); }
    /**
     * Constructs IfcPipeSegmentType with all required attributes.
     */
    ...
    /**
     * Constructs IfcPipeSegmentType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcPipeSegmentTypeEnum value) { this.predefinedType = value; }
