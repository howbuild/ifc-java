 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcopeningstandardcase.htm">IfcOpeningStandardCase</a>
 */
public class IfcOpeningStandardCase extends IfcOpeningElement {

    protected IfcOpeningStandardCase() { initCollections(); }
    /**
     * Constructs IfcOpeningStandardCase with all required attributes.
     */
    ...
    /**
     * Constructs IfcOpeningStandardCase with required and optional attributes.
     */
