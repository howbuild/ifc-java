 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcductsilencer.htm">IfcDuctSilencer</a>
 */
public class IfcDuctSilencer extends IfcFlowTreatmentDevice {
    protected IfcDuctSilencerTypeEnum predefinedType;

    protected IfcDuctSilencer() { initCollections(); }
    /**
     * Constructs IfcDuctSilencer with all required attributes.
     */
    ...
    /**
     * Constructs IfcDuctSilencer with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcDuctSilencerTypeEnum value) { this.predefinedType = value; } // optional
