 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcfiltertype.htm">IfcFilterType</a>
 */
public class IfcFilterType extends IfcFlowTreatmentDeviceType {
    protected IfcFilterTypeEnum predefinedType;

    protected IfcFilterType() { initCollections(); }
    /**
     * Constructs IfcFilterType with all required attributes.
     */
    ...
    /**
     * Constructs IfcFilterType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcFilterTypeEnum value) { this.predefinedType = value; }
