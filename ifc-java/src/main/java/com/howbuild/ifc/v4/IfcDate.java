 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcdate.htm">IfcDate</a>
 */
public class IfcDate extends BaseIfc implements IfcSimpleValue, SimpleType {
