 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcconstructionmaterialresource.htm">IfcConstructionMaterialResource</a>
 */
public class IfcConstructionMaterialResource extends IfcConstructionResource {
    ...
    protected IfcConstructionMaterialResource() { initCollections(); }
    /**
     * Constructs IfcConstructionMaterialResource with all required attributes.
     */
    ...
    /**
     * Constructs IfcConstructionMaterialResource with required and optional attributes.
     */
    public IfcConstructionMaterialResource(IfcGloballyUniqueId globalId,IfcOwnerHistory ownerHistory,IfcLabel name,IfcText description,IfcLabel objectType,IfcIdentifier identification,IfcText longDescription,IfcResourceTime usage,Collection<IfcAppliedValue> baseCosts,IfcPhysicalQuantity baseQuantity,IfcConstructionMaterialResourceTypeEnum predefinedType) {
    ...
    public void setPredefinedType(IfcConstructionMaterialResourceTypeEnum value) { this.predefinedType = value; } // optional
