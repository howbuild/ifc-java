 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcfastener.htm">IfcFastener</a>
 */
public class IfcFastener extends IfcElementComponent {
    protected IfcFastenerTypeEnum predefinedType;

    protected IfcFastener() { initCollections(); }
    /**
     * Constructs IfcFastener with all required attributes.
     */
    ...
    /**
     * Constructs IfcFastener with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcFastenerTypeEnum value) { this.predefinedType = value; } // optional
