 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcboundarycurve.htm">IfcBoundaryCurve</a>
 */
public class IfcBoundaryCurve extends IfcCompositeCurveOnSurface {

    protected IfcBoundaryCurve() { initCollections(); }
    /**
     * Constructs IfcBoundaryCurve with all required attributes.
     */
    public IfcBoundaryCurve(Collection<IfcCompositeCurveSegment> segments,IfcLogical selfIntersect) {
