 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcevaporatortype.htm">IfcEvaporatorType</a>
 */
public class IfcEvaporatorType extends IfcEnergyConversionDeviceType {
    protected IfcEvaporatorTypeEnum predefinedType;

    protected IfcEvaporatorType() { initCollections(); }
    /**
     * Constructs IfcEvaporatorType with all required attributes.
     */
    ...
    /**
     * Constructs IfcEvaporatorType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcEvaporatorTypeEnum value) { this.predefinedType = value; }
