 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcconstructionmaterialresourcetype.htm">IfcConstructionMaterialResourceType</a>
 */
public class IfcConstructionMaterialResourceType extends IfcConstructionResourceType {
    ...
    protected IfcConstructionMaterialResourceType() { initCollections(); }
    /**
     * Constructs IfcConstructionMaterialResourceType with all required attributes.
     */
    ...
    /**
     * Constructs IfcConstructionMaterialResourceType with required and optional attributes.
     */
    public IfcConstructionMaterialResourceType(IfcGloballyUniqueId globalId,IfcOwnerHistory ownerHistory,IfcLabel name,IfcText description,IfcIdentifier applicableOccurrence,Collection<IfcPropertySetDefinition> hasPropertySets,IfcIdentifier identification,IfcText longDescription,IfcLabel resourceType,Collection<IfcAppliedValue> baseCosts,IfcPhysicalQuantity baseQuantity,IfcConstructionMaterialResourceTypeEnum predefinedType) {
    ...
    public IfcConstructionMaterialResourceTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcConstructionMaterialResourceTypeEnum value) { this.predefinedType = value; }
