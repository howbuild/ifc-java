 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcgeographicelementtype.htm">IfcGeographicElementType</a>
 */
public class IfcGeographicElementType extends IfcElementType {
    protected IfcGeographicElementTypeEnum predefinedType;

    protected IfcGeographicElementType() { initCollections(); }
    /**
     * Constructs IfcGeographicElementType with all required attributes.
     */
    ...
    /**
     * Constructs IfcGeographicElementType with required and optional attributes.
     */
    ...
    public IfcGeographicElementTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcGeographicElementTypeEnum value) { this.predefinedType = value; }
