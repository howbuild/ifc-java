 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcfooting.htm">IfcFooting</a>
 */
public class IfcFooting extends IfcBuildingElement {
    protected IfcFootingTypeEnum predefinedType;

    protected IfcFooting() { initCollections(); }
    /**
     * Constructs IfcFooting with all required attributes.
     */
    ...
    /**
     * Constructs IfcFooting with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcFootingTypeEnum value) { this.predefinedType = value; } // optional
