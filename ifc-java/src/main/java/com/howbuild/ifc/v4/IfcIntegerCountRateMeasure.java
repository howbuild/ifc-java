 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcintegercountratemeasure.htm">IfcIntegerCountRateMeasure</a>
 */
public class IfcIntegerCountRateMeasure extends BaseIfc implements IfcDerivedMeasureValue, SimpleType {
    ...
    public IfcIntegerCountRateMeasure(Long value){ this.value = value; }
