 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcdimensioncount.htm">IfcDimensionCount</a>
 */
public class IfcDimensionCount extends BaseIfc implements SimpleType {
    ...
    public IfcDimensionCount(Long value){ this.value = value; }
