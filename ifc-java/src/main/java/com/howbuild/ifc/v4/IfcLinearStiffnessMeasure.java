 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifclinearstiffnessmeasure.htm">IfcLinearStiffnessMeasure</a>
 */
public class IfcLinearStiffnessMeasure extends BaseIfc implements IfcTranslationalStiffnessSelect, IfcDerivedMeasureValue, SimpleType {
