 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcduration.htm">IfcDuration</a>
 */
public class IfcDuration extends BaseIfc implements IfcTimeOrRatioSelect, IfcSimpleValue, SimpleType {
