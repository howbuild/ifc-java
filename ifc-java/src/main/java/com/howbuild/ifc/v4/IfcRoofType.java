 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcrooftype.htm">IfcRoofType</a>
 */
public class IfcRoofType extends IfcBuildingElementType {
    protected IfcRoofTypeEnum predefinedType;

    protected IfcRoofType() { initCollections(); }
    /**
     * Constructs IfcRoofType with all required attributes.
     */
    ...
    /**
     * Constructs IfcRoofType with required and optional attributes.
     */
    ...
    public IfcRoofTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcRoofTypeEnum value) { this.predefinedType = value; }
