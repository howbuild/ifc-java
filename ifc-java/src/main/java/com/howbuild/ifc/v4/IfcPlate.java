 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcplate.htm">IfcPlate</a>
 */
public class IfcPlate extends IfcBuildingElement {
    protected IfcPlateTypeEnum predefinedType;

    protected IfcPlate() { initCollections(); }
    /**
     * Constructs IfcPlate with all required attributes.
     */
    ...
    /**
     * Constructs IfcPlate with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcPlateTypeEnum value) { this.predefinedType = value; } // optional
