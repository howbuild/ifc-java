 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcpiletype.htm">IfcPileType</a>
 */
public class IfcPileType extends IfcBuildingElementType {
    protected IfcPileTypeEnum predefinedType;

    protected IfcPileType() { initCollections(); }
    /**
     * Constructs IfcPileType with all required attributes.
     */
    ...
    /**
     * Constructs IfcPileType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcPileTypeEnum value) { this.predefinedType = value; }
