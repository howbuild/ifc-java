 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcairtoairheatrecoverytype.htm">IfcAirToAirHeatRecoveryType</a>
 */
public class IfcAirToAirHeatRecoveryType extends IfcEnergyConversionDeviceType {
    protected IfcAirToAirHeatRecoveryTypeEnum predefinedType;

    protected IfcAirToAirHeatRecoveryType() { initCollections(); }
    /**
     * Constructs IfcAirToAirHeatRecoveryType with all required attributes.
     */
    ...
    /**
     * Constructs IfcAirToAirHeatRecoveryType with required and optional attributes.
     */
    ...
    public IfcAirToAirHeatRecoveryTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcAirToAirHeatRecoveryTypeEnum value) { this.predefinedType = value; }
