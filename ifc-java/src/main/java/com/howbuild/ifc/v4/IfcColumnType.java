 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccolumntype.htm">IfcColumnType</a>
 */
public class IfcColumnType extends IfcBuildingElementType {
    protected IfcColumnTypeEnum predefinedType;

    protected IfcColumnType() { initCollections(); }
    /**
     * Constructs IfcColumnType with all required attributes.
     */
    ...
    /**
     * Constructs IfcColumnType with required and optional attributes.
     */
    ...
    public IfcColumnTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcColumnTypeEnum value) { this.predefinedType = value; }
