 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcevaporativecooler.htm">IfcEvaporativeCooler</a>
 */
public class IfcEvaporativeCooler extends IfcEnergyConversionDevice {
    protected IfcEvaporativeCoolerTypeEnum predefinedType;

    protected IfcEvaporativeCooler() { initCollections(); }
    /**
     * Constructs IfcEvaporativeCooler with all required attributes.
     */
    ...
    /**
     * Constructs IfcEvaporativeCooler with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcEvaporativeCoolerTypeEnum value) { this.predefinedType = value; } // optional
