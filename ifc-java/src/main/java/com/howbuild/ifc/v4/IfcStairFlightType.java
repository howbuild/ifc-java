 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcstairflighttype.htm">IfcStairFlightType</a>
 */
public class IfcStairFlightType extends IfcBuildingElementType {
    protected IfcStairFlightTypeEnum predefinedType;

    protected IfcStairFlightType() { initCollections(); }
    /**
     * Constructs IfcStairFlightType with all required attributes.
     */
    ...
    /**
     * Constructs IfcStairFlightType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcStairFlightTypeEnum value) { this.predefinedType = value; }
