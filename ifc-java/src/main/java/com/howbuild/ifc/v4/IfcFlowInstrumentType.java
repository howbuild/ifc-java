 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcflowinstrumenttype.htm">IfcFlowInstrumentType</a>
 */
public class IfcFlowInstrumentType extends IfcDistributionControlElementType {
    ...
    protected IfcFlowInstrumentType() { initCollections(); }
    /**
     * Constructs IfcFlowInstrumentType with all required attributes.
     */
    ...
    /**
     * Constructs IfcFlowInstrumentType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcFlowInstrumentTypeEnum value) { this.predefinedType = value; }
