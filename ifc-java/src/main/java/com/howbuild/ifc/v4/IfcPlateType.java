 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcplatetype.htm">IfcPlateType</a>
 */
public class IfcPlateType extends IfcBuildingElementType {
    protected IfcPlateTypeEnum predefinedType;

    protected IfcPlateType() { initCollections(); }
    /**
     * Constructs IfcPlateType with all required attributes.
     */
    ...
    /**
     * Constructs IfcPlateType with required and optional attributes.
     */
    ...
    public IfcPlateTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcPlateTypeEnum value) { this.predefinedType = value; }
