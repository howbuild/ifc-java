 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcfurnishingelement.htm">IfcFurnishingElement</a>
 */
public class IfcFurnishingElement extends IfcElement {

    protected IfcFurnishingElement() { initCollections(); }
    /**
     * Constructs IfcFurnishingElement with all required attributes.
     */
    public IfcFurnishingElement(IfcGloballyUniqueId globalId) {

        super(globalId);
    }
    /**
     * Constructs IfcFurnishingElement with required and optional attributes.
     */
