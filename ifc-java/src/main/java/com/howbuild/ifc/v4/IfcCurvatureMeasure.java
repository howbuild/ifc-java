 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccurvaturemeasure.htm">IfcCurvatureMeasure</a>
 */
public class IfcCurvatureMeasure extends BaseIfc implements IfcDerivedMeasureValue, SimpleType {
