 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcburner.htm">IfcBurner</a>
 */
public class IfcBurner extends IfcEnergyConversionDevice {
    protected IfcBurnerTypeEnum predefinedType;

    protected IfcBurner() { initCollections(); }
    /**
     * Constructs IfcBurner with all required attributes.
     */
    ...
    /**
     * Constructs IfcBurner with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcBurnerTypeEnum value) { this.predefinedType = value; } // optional
