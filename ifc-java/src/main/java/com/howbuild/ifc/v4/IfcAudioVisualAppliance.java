 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcaudiovisualappliance.htm">IfcAudioVisualAppliance</a>
 */
public class IfcAudioVisualAppliance extends IfcFlowTerminal {
    protected IfcAudioVisualApplianceTypeEnum predefinedType;

    protected IfcAudioVisualAppliance() { initCollections(); }
    /**
     * Constructs IfcAudioVisualAppliance with all required attributes.
     */
    ...
    /**
     * Constructs IfcAudioVisualAppliance with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcAudioVisualApplianceTypeEnum value) { this.predefinedType = value; } // optional
