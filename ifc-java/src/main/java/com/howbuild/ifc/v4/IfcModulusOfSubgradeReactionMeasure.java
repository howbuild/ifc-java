 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcmodulusofsubgradereactionmeasure.htm">IfcModulusOfSubgradeReactionMeasure</a>
 */
public class IfcModulusOfSubgradeReactionMeasure extends BaseIfc implements IfcModulusOfSubgradeReactionSelect, IfcDerivedMeasureValue, SimpleType {
