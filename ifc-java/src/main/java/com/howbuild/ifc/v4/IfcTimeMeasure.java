 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifctimemeasure.htm">IfcTimeMeasure</a>
 */
public class IfcTimeMeasure extends BaseIfc implements IfcMeasureValue, SimpleType {
