 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcchimney.htm">IfcChimney</a>
 */
public class IfcChimney extends IfcBuildingElement {
    protected IfcChimneyTypeEnum predefinedType;

    protected IfcChimney() { initCollections(); }
    /**
     * Constructs IfcChimney with all required attributes.
     */
    ...
    /**
     * Constructs IfcChimney with required and optional attributes.
     */
    ...
    public IfcChimneyTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcChimneyTypeEnum value) { this.predefinedType = value; } // optional
