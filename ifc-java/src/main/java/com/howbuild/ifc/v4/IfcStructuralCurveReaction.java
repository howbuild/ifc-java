 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcstructuralcurvereaction.htm">IfcStructuralCurveReaction</a>
 */
public class IfcStructuralCurveReaction extends IfcStructuralReaction {
    ...
    protected IfcStructuralCurveReaction() { initCollections(); }
    /**
     * Constructs IfcStructuralCurveReaction with all required attributes.
     */
    ...
    /**
     * Constructs IfcStructuralCurveReaction with required and optional attributes.
     */
