 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccartesianpointlist3d.htm">IfcCartesianPointList3D</a>
 */
public class IfcCartesianPointList3D extends IfcCartesianPointList {
    ...
    protected IfcCartesianPointList3D() { initCollections(); }
    /**
     * Constructs IfcCartesianPointList3D with all required attributes.
     */
    public IfcCartesianPointList3D(Collection<Collection<IfcLengthMeasure>> coordList) {
        super();
