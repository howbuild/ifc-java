 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcflowfitting.htm">IfcFlowFitting</a>
 */
public class IfcFlowFitting extends IfcDistributionFlowElement {

    protected IfcFlowFitting() { initCollections(); }
    /**
     * Constructs IfcFlowFitting with all required attributes.
     */
    ...
    /**
     * Constructs IfcFlowFitting with required and optional attributes.
     */
