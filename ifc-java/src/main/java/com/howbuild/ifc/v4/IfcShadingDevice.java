 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcshadingdevice.htm">IfcShadingDevice</a>
 */
public class IfcShadingDevice extends IfcBuildingElement {
    protected IfcShadingDeviceTypeEnum predefinedType;

    protected IfcShadingDevice() { initCollections(); }
    /**
     * Constructs IfcShadingDevice with all required attributes.
     */
    ...
    /**
     * Constructs IfcShadingDevice with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcShadingDeviceTypeEnum value) { this.predefinedType = value; } // optional
