 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcsolidanglemeasure.htm">IfcSolidAngleMeasure</a>
 */
public class IfcSolidAngleMeasure extends BaseIfc implements IfcMeasureValue, SimpleType {
