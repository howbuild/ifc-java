 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcramp.htm">IfcRamp</a>
 */
public class IfcRamp extends IfcBuildingElement {
    protected IfcRampTypeEnum predefinedType;

    protected IfcRamp() { initCollections(); }
    /**
     * Constructs IfcRamp with all required attributes.
     */
    ...
    /**
     * Constructs IfcRamp with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcRampTypeEnum value) { this.predefinedType = value; } // optional
