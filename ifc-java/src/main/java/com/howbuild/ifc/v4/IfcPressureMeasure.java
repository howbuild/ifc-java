 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcpressuremeasure.htm">IfcPressureMeasure</a>
 */
public class IfcPressureMeasure extends BaseIfc implements IfcDerivedMeasureValue, SimpleType {
