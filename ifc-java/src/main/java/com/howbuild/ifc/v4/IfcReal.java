 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcreal.htm">IfcReal</a>
 */
public class IfcReal extends BaseIfc implements IfcSimpleValue, SimpleType {
