 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcflowterminal.htm">IfcFlowTerminal</a>
 */
public class IfcFlowTerminal extends IfcDistributionFlowElement {

    protected IfcFlowTerminal() { initCollections(); }
    /**
     * Constructs IfcFlowTerminal with all required attributes.
     */
    ...
    /**
     * Constructs IfcFlowTerminal with required and optional attributes.
     */
