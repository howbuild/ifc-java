 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcelectrictimecontroltype.htm">IfcElectricTimeControlType</a>
 */
public class IfcElectricTimeControlType extends IfcFlowControllerType {
    ...
    protected IfcElectricTimeControlType() { initCollections(); }
    /**
     * Constructs IfcElectricTimeControlType with all required attributes.
     */
    ...
    /**
     * Constructs IfcElectricTimeControlType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcElectricTimeControlTypeEnum value) { this.predefinedType = value; }
