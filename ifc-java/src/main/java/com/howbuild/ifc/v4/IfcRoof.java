 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcroof.htm">IfcRoof</a>
 */
public class IfcRoof extends IfcBuildingElement {
    protected IfcRoofTypeEnum predefinedType;

    protected IfcRoof() { initCollections(); }
    /**
     * Constructs IfcRoof with all required attributes.
     */
    ...
    /**
     * Constructs IfcRoof with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcRoofTypeEnum value) { this.predefinedType = value; } // optional
