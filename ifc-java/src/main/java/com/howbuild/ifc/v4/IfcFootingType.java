 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcfootingtype.htm">IfcFootingType</a>
 */
public class IfcFootingType extends IfcBuildingElementType {
    protected IfcFootingTypeEnum predefinedType;

    protected IfcFootingType() { initCollections(); }
    /**
     * Constructs IfcFootingType with all required attributes.
     */
    ...
    /**
     * Constructs IfcFootingType with required and optional attributes.
     */
    ...
    public IfcFootingTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcFootingTypeEnum value) { this.predefinedType = value; }
