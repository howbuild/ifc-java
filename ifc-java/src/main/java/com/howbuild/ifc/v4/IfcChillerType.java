 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcchillertype.htm">IfcChillerType</a>
 */
public class IfcChillerType extends IfcEnergyConversionDeviceType {
    protected IfcChillerTypeEnum predefinedType;

    protected IfcChillerType() { initCollections(); }
    /**
     * Constructs IfcChillerType with all required attributes.
     */
    ...
    /**
     * Constructs IfcChillerType with required and optional attributes.
     */
    ...
    public IfcChillerTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcChillerTypeEnum value) { this.predefinedType = value; }
