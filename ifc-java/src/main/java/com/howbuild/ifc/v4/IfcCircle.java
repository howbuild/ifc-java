 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccircle.htm">IfcCircle</a>
 */
public class IfcCircle extends IfcConic {
    protected IfcPositiveLengthMeasure radius;

    protected IfcCircle() { initCollections(); }
    /**
     * Constructs IfcCircle with all required attributes.
     */
