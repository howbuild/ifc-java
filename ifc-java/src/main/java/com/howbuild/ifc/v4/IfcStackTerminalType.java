 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcstackterminaltype.htm">IfcStackTerminalType</a>
 */
public class IfcStackTerminalType extends IfcFlowTerminalType {
    protected IfcStackTerminalTypeEnum predefinedType;

    protected IfcStackTerminalType() { initCollections(); }
    /**
     * Constructs IfcStackTerminalType with all required attributes.
     */
    ...
    /**
     * Constructs IfcStackTerminalType with required and optional attributes.
     */
    ...
    public IfcStackTerminalTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcStackTerminalTypeEnum value) { this.predefinedType = value; }
