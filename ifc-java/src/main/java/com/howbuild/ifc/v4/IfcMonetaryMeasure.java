 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcmonetarymeasure.htm">IfcMonetaryMeasure</a>
 */
public class IfcMonetaryMeasure extends BaseIfc implements IfcDerivedMeasureValue, SimpleType {
