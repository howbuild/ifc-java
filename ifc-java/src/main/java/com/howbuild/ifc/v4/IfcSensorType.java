 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcsensortype.htm">IfcSensorType</a>
 */
public class IfcSensorType extends IfcDistributionControlElementType {
    protected IfcSensorTypeEnum predefinedType;

    protected IfcSensorType() { initCollections(); }
    /**
     * Constructs IfcSensorType with all required attributes.
     */
    ...
    /**
     * Constructs IfcSensorType with required and optional attributes.
     */
    ...
    public IfcSensorTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcSensorTypeEnum value) { this.predefinedType = value; }
