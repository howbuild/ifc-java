 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcflowsegment.htm">IfcFlowSegment</a>
 */
public class IfcFlowSegment extends IfcDistributionFlowElement {

    protected IfcFlowSegment() { initCollections(); }
    /**
     * Constructs IfcFlowSegment with all required attributes.
     */
    ...
    /**
     * Constructs IfcFlowSegment with required and optional attributes.
     */
