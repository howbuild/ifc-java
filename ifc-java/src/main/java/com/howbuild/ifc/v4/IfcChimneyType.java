 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcchimneytype.htm">IfcChimneyType</a>
 */
public class IfcChimneyType extends IfcBuildingElementType {
    protected IfcChimneyTypeEnum predefinedType;

    protected IfcChimneyType() { initCollections(); }
    /**
     * Constructs IfcChimneyType with all required attributes.
     */
    ...
    /**
     * Constructs IfcChimneyType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcChimneyTypeEnum value) { this.predefinedType = value; }
