 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcwall.htm">IfcWall</a>
 */
public class IfcWall extends IfcBuildingElement {
    protected IfcWallTypeEnum predefinedType;

    protected IfcWall() { initCollections(); }
    /**
     * Constructs IfcWall with all required attributes.
     */
    ...
    /**
     * Constructs IfcWall with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcWallTypeEnum value) { this.predefinedType = value; } // optional
