 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcmedicaldevice.htm">IfcMedicalDevice</a>
 */
public class IfcMedicalDevice extends IfcFlowTerminal {
    protected IfcMedicalDeviceTypeEnum predefinedType;

    protected IfcMedicalDevice() { initCollections(); }
    /**
     * Constructs IfcMedicalDevice with all required attributes.
     */
    ...
    /**
     * Constructs IfcMedicalDevice with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcMedicalDeviceTypeEnum value) { this.predefinedType = value; } // optional
