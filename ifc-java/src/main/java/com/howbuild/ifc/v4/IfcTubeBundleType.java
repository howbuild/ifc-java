 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifctubebundletype.htm">IfcTubeBundleType</a>
 */
public class IfcTubeBundleType extends IfcEnergyConversionDeviceType {
    protected IfcTubeBundleTypeEnum predefinedType;

    protected IfcTubeBundleType() { initCollections(); }
    /**
     * Constructs IfcTubeBundleType with all required attributes.
     */
    ...
    /**
     * Constructs IfcTubeBundleType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcTubeBundleTypeEnum value) { this.predefinedType = value; }
