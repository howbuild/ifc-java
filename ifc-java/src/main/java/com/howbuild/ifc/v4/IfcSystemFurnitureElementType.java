 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcsystemfurnitureelementtype.htm">IfcSystemFurnitureElementType</a>
 */
public class IfcSystemFurnitureElementType extends IfcFurnishingElementType {
    ...
    protected IfcSystemFurnitureElementType() { initCollections(); }
    /**
     * Constructs IfcSystemFurnitureElementType with all required attributes.
     */
    ...
    /**
     * Constructs IfcSystemFurnitureElementType with required and optional attributes.
     */
