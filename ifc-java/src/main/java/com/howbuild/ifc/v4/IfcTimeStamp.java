 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifctimestamp.htm">IfcTimeStamp</a>
 */
public class IfcTimeStamp extends BaseIfc implements IfcSimpleValue, SimpleType {
    ...
    public IfcTimeStamp(Long value){ this.value = value; }
    public IfcTimeStamp() { }
