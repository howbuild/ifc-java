 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccoil.htm">IfcCoil</a>
 */
public class IfcCoil extends IfcEnergyConversionDevice {
    protected IfcCoilTypeEnum predefinedType;

    protected IfcCoil() { initCollections(); }
    /**
     * Constructs IfcCoil with all required attributes.
     */
    ...
    /**
     * Constructs IfcCoil with required and optional attributes.
     */
    ...
    public IfcCoilTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcCoilTypeEnum value) { this.predefinedType = value; } // optional
