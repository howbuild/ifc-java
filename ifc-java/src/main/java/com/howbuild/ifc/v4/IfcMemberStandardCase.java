 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcmemberstandardcase.htm">IfcMemberStandardCase</a>
 */
public class IfcMemberStandardCase extends IfcMember {

    protected IfcMemberStandardCase() { initCollections(); }
    /**
     * Constructs IfcMemberStandardCase with all required attributes.
     */
    public IfcMemberStandardCase(IfcGloballyUniqueId globalId) {

        super(globalId);
    }
    /**
     * Constructs IfcMemberStandardCase with required and optional attributes.
     */
