 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcbuildingelementproxytype.htm">IfcBuildingElementProxyType</a>
 */
public class IfcBuildingElementProxyType extends IfcBuildingElementType {
    protected IfcBuildingElementProxyTypeEnum predefinedType;

    protected IfcBuildingElementProxyType() { initCollections(); }
    /**
     * Constructs IfcBuildingElementProxyType with all required attributes.
     */
    ...
    /**
     * Constructs IfcBuildingElementProxyType with required and optional attributes.
     */
    ...
    public IfcBuildingElementProxyTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcBuildingElementProxyTypeEnum value) { this.predefinedType = value; }
