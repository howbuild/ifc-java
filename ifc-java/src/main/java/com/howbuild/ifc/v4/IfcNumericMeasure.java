 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcnumericmeasure.htm">IfcNumericMeasure</a>
 */
public class IfcNumericMeasure extends BaseIfc implements IfcMeasureValue, SimpleType {
