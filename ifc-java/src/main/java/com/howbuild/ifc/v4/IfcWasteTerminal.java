 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcwasteterminal.htm">IfcWasteTerminal</a>
 */
public class IfcWasteTerminal extends IfcFlowTerminal {
    protected IfcWasteTerminalTypeEnum predefinedType;

    protected IfcWasteTerminal() { initCollections(); }
    /**
     * Constructs IfcWasteTerminal with all required attributes.
     */
    ...
    /**
     * Constructs IfcWasteTerminal with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcWasteTerminalTypeEnum value) { this.predefinedType = value; } // optional
