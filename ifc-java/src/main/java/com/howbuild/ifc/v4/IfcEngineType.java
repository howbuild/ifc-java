 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcenginetype.htm">IfcEngineType</a>
 */
public class IfcEngineType extends IfcEnergyConversionDeviceType {
    protected IfcEngineTypeEnum predefinedType;

    protected IfcEngineType() { initCollections(); }
    /**
     * Constructs IfcEngineType with all required attributes.
     */
    ...
    /**
     * Constructs IfcEngineType with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcEngineTypeEnum value) { this.predefinedType = value; }
