 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifcductfittingtype.htm">IfcDuctFittingType</a>
 */
public class IfcDuctFittingType extends IfcFlowFittingType {
    protected IfcDuctFittingTypeEnum predefinedType;

    protected IfcDuctFittingType() { initCollections(); }
    /**
     * Constructs IfcDuctFittingType with all required attributes.
     */
    ...
    /**
     * Constructs IfcDuctFittingType with required and optional attributes.
     */
    ...
    public IfcDuctFittingTypeEnum getPredefinedType() { return this.predefinedType; }
    public void setPredefinedType(IfcDuctFittingTypeEnum value) { this.predefinedType = value; }
