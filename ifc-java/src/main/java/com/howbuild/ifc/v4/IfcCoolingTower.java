 ...
 * }</pre>
 *
 * @see <a href="https://standards.buildingsmart.org/IFC/DEV/IFC4_2/FINAL/HTML/link/ifccoolingtower.htm">IfcCoolingTower</a>
 */
public class IfcCoolingTower extends IfcEnergyConversionDevice {
    protected IfcCoolingTowerTypeEnum predefinedType;

    protected IfcCoolingTower() { initCollections(); }
    /**
     * Constructs IfcCoolingTower with all required attributes.
     */
    ...
    /**
     * Constructs IfcCoolingTower with required and optional attributes.
     */
    ...
    public void setPredefinedType(IfcCoolingTowerTypeEnum value) { this.predefinedType = value; } // optional
